...
export const sendBookingNotificationEmail = async (booking: BookingEmailPayload): Promise<boolean> => {
  ...
  try {
    ...
    console.error('⚠️ Failed to dispatch SMTP email notification:', (err as Error).message);
    return false;
  }
};
